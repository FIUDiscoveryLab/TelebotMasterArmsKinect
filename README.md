# TelebotMasterArmsKinect
Telebot Master Component for Kinect Control for Arms

##Installation

###Git
`git clone --recursive https://github.com/FIUDiscoveryLab/TelebotMasterArmsKinect.git`
